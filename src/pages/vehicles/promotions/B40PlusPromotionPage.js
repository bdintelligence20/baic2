...
const B40PlusPromotionPage = () => {
  return (
    <PromotionContainer>
      <PromotionHeader>
        <Title>B40 Plus Adventure Offer</Title>
        <Subtitle>Conquer any terrain with our exclusive B40 Plus off-road champion</Subtitle>
      </PromotionHeader>
      
      <PromotionContent>
        <PromotionImage>
          <img src="/images/models/b40-plus/BJ40 plus 黑_20221028105044A009.png" alt="BAIC B40 Plus" />
        </PromotionImage>
        
        <PromotionDetails>
          <PromotionPrice>From R574,500</PromotionPrice>
          <PromotionDescription>
            Embrace adventure with the rugged BAIC B40 Plus. For a limited time, enjoy special financing and exclusive off-road packages with your purchase.
          </PromotionDescription>
          
          <PromotionFeatures>
            <li>0% Deposit</li>
            <li>5.9% Interest Rate</li>
            <li>Free 5-Year Service Plan</li>
            <li>5-Year/120,000 km Warranty</li>
            <li>Off-Road Accessory Package Included</li>
            <li>Free Off-Road Driving Course</li>
...
export default B40PlusPromotionPage;
