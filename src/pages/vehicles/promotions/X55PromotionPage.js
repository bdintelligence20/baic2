...
const X55PromotionPage = () => {
  return (
    <PromotionContainer>
      <PromotionHeader>
        <Title>X55 Special Offer</Title>
        <Subtitle>Experience urban elegance with our limited-time promotion on the BAIC X55</Subtitle>
      </PromotionHeader>
      
      <PromotionContent>
        <PromotionImage>
          <img src="/images/models/x55/14_20240708121758A006.png" alt="BAIC X55" />
        </PromotionImage>
        
        <PromotionDetails>
          <PromotionPrice>From R399,900</PromotionPrice>
          <PromotionDescription>
            For a limited time, drive away in the stylish and feature-packed BAIC X55 with special financing options and added value.
          </PromotionDescription>
          
          <PromotionFeatures>
            <li>0% Deposit</li>
            <li>5.9% Interest Rate</li>
            <li>Free 3-Year Service Plan</li>
            <li>5-Year/120,000 km Warranty</li>
            <li>Free Window Tinting & Floor Mats</li>
          </PromotionFeatures>
...
export default X55PromotionPage;
